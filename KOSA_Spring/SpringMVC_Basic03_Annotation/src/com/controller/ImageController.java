...
public class ImageController {
	...
	public String submit(Photo photo, HttpServletRequest request) {
		/*
		 ...
		 1.1 자동화: name 속성값이 Photo 타입의 클래스의 member field 이름과 동일
		 2. public String submit(Photo photo) 내부적으로... (자동화)
		 	>> Photo photo = new Photo();
		 	>> photo.setName("홍길동");
		 	>> photo.setImage() >> 자동 주입 안돼요 >> 수동으로(코드로) 끄집어 내야됨.. >> 가공 CommonsMultipartFile 추출(이름)
		...
		System.out.println("imagefile getOriginalFilename: " + imagefile.getName());
