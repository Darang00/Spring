...
public class BoardController {
	...
	/*
	@Autowired
	public void setSqlsession(SqlSession sqlsession) { //setter 함수로 주입하는 방법
    ...
    */
	...
	public String write(BoardDTO dto) {
		...
		// BoardDao.xml 에서 namespace가 BoardDAO.java 인터페이스 경로랑 똑같이 썼다는 선행조건
		// 전제 : 1. namespace , 2. id=method
		// mapper가 interface를 구현했다.
